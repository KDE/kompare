...
void DiffPage::addDiffTab()
{
	...
	m_diffProgramGroup = new Q3VButtonGroup( i18n( "Diff Program" ), page );
...
void DiffPage::addFormatTab()
{
	...
	// add diff modes
	m_modeButtonGroup = new Q3VButtonGroup( i18n( "Output Format" ), page );
	...
	Q3WhatsThis::add( m_locSpinBox, i18n( "The number of context lines is normally 2 or 3. This makes the diff readable and applicable in most cases. More than 3 lines will only bloat the diff unnecessarily." ) );
...
void DiffPage::addOptionsTab()
{
	...
	// add diff options
	Q3VButtonGroup* optionButtonGroup     = new Q3VButtonGroup( i18n( "General" ), page );
	...
	if ( !KTrader::self()->query("KRegExpEditor/KRegExpEditor").isEmpty() )
	{
		...
		Q3Button* ignoreRegExpEditButton = new QPushButton( i18n( "&Edit..." ), page, "regexp_editor_button" );
	...
	Q3VButtonGroup* moreOptionButtonGroup = new Q3VButtonGroup( i18n( "Whitespace" ), page );
